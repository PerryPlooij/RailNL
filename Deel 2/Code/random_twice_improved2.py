...
class Routes():
    ...
    def randomsolution(self):
        ...
        # while bestquality < 7500:
            ...
            while maxtime <= 180:
                ...
                while len(self.allconnections2.keys()) != 0 and count <= 12:
                    if self.start:
                        city = self.start[0] 
    ...
    def hist(self):
        ...
        plt.xlabel("Score")
        plt.ylabel("Count")
        plt.title("random_twice_improved2")
        plt.show
    ...
    def maketraject(self, city, count, maxtime):
        ...
        while time < maxtime and count <= 12 and city in self.allconnections:
            best_stop_time = 100
            best_stop_city = ""
