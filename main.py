...
if __name__ == '__main__':
    ...
    # Run part 1 of the case (stations in North- and South-Holland).
    if args.part == 1:
        name = "Part1"
        timeframe = 120
        maxtrajects = 7
        connections = 'Attachment/ConnectiesHolland.csv'
    ...
    # Run part 2 of the case (all stations in the Netherlands).
        ...
        timeframe = 180
        maxtrajects = 20
        connections = 'Attachment/ConnectiesNationaal.csv'

    import_info = load.Load(connections, stations)
    ...
    # Run the depth first algoritm.
        ...
        best = depth_first.Depth_first(import_info.connections, import_info.stations, timeframe, maxtrajects)
